    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/blog/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
        ...
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('Attribute/lst');?>" target="main-frame">商品属性列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Attribute/add');?>" target="main-frame">添加商品属性</a></li>
                    <li class="menu-item"><a href="<?php echo U('Brand/lst');?>" target="main-frame">商品品牌列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Brand/add');?>" target="main-frame">商品添加品牌</a></li>
                    <li class="menu-item"><a href="<?php echo U('Category/lst');?>" target="main-frame">商品分类列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Category/add');?>" target="main-frame">商品添加分类</a></li>
            ...
            订单管理
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('Type/add');?>" target="main-frame">添加类型</a></li>
                </ul>
            </li>
            <li class="explode" key="08_members" name="menu">
            会员管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('Admin/lst');?>" target="main-frame">会员列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('Admin/add');?>" target="main-frame">添加会员</a></li>
                    <li class="menu-item"><a href="<?php echo U('MemberLevel/lst');?>" target="main-frame">会员级别列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('MemberLevel/add');?>" target="main-frame">添加分类会员级别</a></li>
                </ul>
            </li>
             <li class="explode" key="08_members" name="menu">
            权限管理
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('Privilege/add');?>" target="main-frame">添加权限</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script type="text/javascript" src="/blog/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/blog/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/blog/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/blog/Public/Admin/Images/menu_minus.gif' : '/blog/Public/Admin/Images/menu_plus.gif';
