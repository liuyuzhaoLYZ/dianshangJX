...
<link rel="stylesheet" href="/blog/Public/Home/style/fillin.css" type="text/css">
<script type="text/javascript" src="/blog/Public/Home/js/cart2.js"></script>
	
	<!-- 页面头部 start -->
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="/blog/Public/Home/images/logo.png" alt="京西商城"></a></h2>
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select none">
					...
					<form action="/blog/index.php/Home/Order/add.html" method="POST" class="none" name="address_form">
						<ul>
							<li>
